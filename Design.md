...
**违反检测**：
```bash
grep -nE '[0-9]+\s*(cm|mm|in)\b' theme/*.sty modules/*.def
# 结果必须为空
```
...
% Phase 1: 选项解析
% ══════════════════════════════════════════════
\input{modules/cxslide-options.def}
\ProcessKeyOptions[cxslide]

% ══════════════════════════════════════════════
% Phase 2: 诊断系统
% ══════════════════════════════════════════════
\input{modules/cxslide-diag.def}
...
% Phase 5: 功能模块
% ══════════════════════════════════════════════
\input{modules/cxslide-math.def}
\input{modules/cxslide-layout.def}
\input{modules/cxslide-code.def}
\input{modules/cxslide-overlay.def}
\input{modules/cxslide-output.def}
\input{modules/cxslide-titlepage.def}
\input{modules/cxslide-enhance.def}
...
% 加载调色板
\input{modules/cxslide-palette-data.def}
\input{modules/cxslide-palette-load.def}
...
- [x] `main-minimal.tex`：最小示例编译通过，当前日志未检出 warning/error
...
- [x] `main.tex` 示例覆盖所有主要功能
- [x] `main-minimal.tex` 最小可编译示例
